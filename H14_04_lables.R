...
write.csv(l_Pil1, file = "./data/labels_Pil1.csv", row.names = FALSE)
...
write.csv(l_Pil2, file = "./data/labels_Pil2.csv", row.names = FALSE)
...
write.csv(l_Pil3, file = "./data/labels_Pil3.csv", row.names = FALSE)
